...
urlpatterns = [
    path("goal_category/create", views.GoalCategoryCreateView2.as_view(), name='create-category2'),
    path("goal_category/create2", views.GoalCategoryCreateView.as_view(), name='create-category'),
